...
struct AssistProgramConfig
{
    ...
    uint32_t treatTimeInterval = 1000;          ///< 使用治疗药水的最小间隔。
    ...
    double masterTreatHpThresold = 0.412752;    ///< 主人机治疗阈值。
    double footmanTreatHpThresold = 0.302752;   ///< 仆从机治疗阈值。
    double footmanBackHomeHpThreshold = 0.935369;   ///< 当血条降低到此阈值时将仆从回城，并退出工作线程，以防游戏人物意外死亡。
